...
public class SecurityConfig {
    ...
    private static final String[] adminUrls =
                        {
                                ...
                                "/api/v1/customer/export/all",
                                "/api/v1/customer/export/all/{offset}/{pageSize}",
                                "/api/v1/address/**",
                                "/api/v1/card/**",
                                ...
                                "api/v1/history/export/all",
                                "api/v1/history/export/all/{offset}/{pageSize}",
                                "/api/v1/history/{id}/export/pdf",
                                "api/v1/productSold/**",
                                "/api/v1/productStock/save",
                                "/api/v1/productStock/{id}/remove",
                                "/api/v1/productStock/{id}/edit",
                                "/api/v1/productStock/export/all",
                                "/api/v1/productStock/export/all/{offset}/{pageSize}",
                                ...
                                "/api/v1/sale/find/date/{date}/{offset}/{pageSize}",
                                "/api/v1/sale/find/date/{date}",
                                "/api/v1/find/date/{start}/{end}/{offset}/{pageSize}",
                                "/api/v1/find/date/{start}/{end}",
                                "/api/v1/sale/export/all",
                                "/api/v1/sale/{id}/export/pdf",
                                "/api/v1/sale/export/all/{offset}/{pageSize}",
                                "/api/v1/payment/edit/{id}",
                                "/api/v1/payment/find",
                                "/api/v1/payment/remove/{id}",
                                "/api/v1/payment/find/status/{status}",
                                "/api/v1/payment/find/{id}/customer",
                                "/api/v1/payment/export/all",
                                "/api/v1/payment/export/all/{offset}/{pageSize}",
                                "/api/v1/payment/find/{id}/card",
                                "/api/v1/cancelled/find/{id}",
                                "/api/v1/cancelled/find",
                                "/api/v1/cancelled/find/{offset}/{pageSize}",
                                "/api/v1/cancelled/export/all",
                                "/api/v1/cancelled/export/all/{offset}/{pageSize}"
    ...
    private static final String[] customersUrls =
                        {"/api/v1/customer/find/{id}",
                         ...
                         "/api/v1/customer/{id}/export/pdf",
                         "/api/v1/history/{id}/add/sale",
                         "/api/v1/sale/{customerId}/save",
