...
--productStock
insert into product_stock (name, amount, price_per_unit, bar_code, enable_product,version) values ('Kris', 77, 890, '70-935-0702',true,1L );
insert into product_stock (name, amount, price_per_unit, bar_code, enable_product,version) values ('Alissa', 25, 896, '22-685-1621',true,1L );
insert into product_stock (name, amount, price_per_unit, bar_code, enable_product,version) values ('Cynthie', 48, 563, '04-714-3217',true,1L );
insert into product_stock (name, amount, price_per_unit, bar_code, enable_product,version) values ('Rhetta', 10, 559, '20-143-5181', true,1L);
insert into product_stock (name, amount, price_per_unit, bar_code, enable_product,version) values ('Bendick', 11, 72, '12-786-0228', true,1L);
insert into product_stock (name, amount, price_per_unit, bar_code, enable_product,version) values ('Darby', 68, 141, '97-002-2471',true,1L );
insert into product_stock (name, amount, price_per_unit, bar_code, enable_product,version) values ('Isabel', 49, 55, '88-485-4769', true,1L);
insert into product_stock (name, amount, price_per_unit, bar_code, enable_product,version) values ('Marijo', 60, 552, '65-445-4335',true ,1L);
insert into product_stock (name, amount, price_per_unit, bar_code, enable_product,version) values ('Lonnard', 66, 905, '43-754-3444',true ,1L);
insert into product_stock (name, amount, price_per_unit, bar_code, enable_product,version) values ('Rancell', 26, 329, '53-914-3899', true,1L);
insert into product_stock (name, amount, price_per_unit, bar_code, enable_product,version) values ('Sydney', 79, 830, '11-823-2227', true,1L);
insert into product_stock (name, amount, price_per_unit, bar_code, enable_product,version) values ('Belita', 9, 517, '70-630-4569', true,1L);
insert into product_stock (name, amount, price_per_unit, bar_code, enable_product,version) values ('Hatty', 11, 515, '81-142-2818', true,1L);
insert into product_stock (name, amount, price_per_unit, bar_code, enable_product,version) values ('Michele', 25, 676, '52-434-9596', true,1L);
insert into product_stock (name, amount, price_per_unit, bar_code, enable_product,version) values ('Raymond', 41, 727, '74-218-9040', true,1L);
insert into product_stock (name, amount, price_per_unit, bar_code, enable_product,version) values ('Kyle', 21, 996, '61-324-0377', true,1L);
insert into product_stock (name, amount, price_per_unit, bar_code, enable_product,version) values ('Celine', 73, 433, '47-827-0705', true,1L);
insert into product_stock (name, amount, price_per_unit, bar_code, enable_product,version) values ('Yancy', 24, 879, '55-326-8926', true,1L);
insert into product_stock (name, amount, price_per_unit, bar_code, enable_product,version) values ('Rafaelia', 78, 393, '25-973-8065', true,1L);
insert into product_stock (name, amount, price_per_unit, bar_code, enable_product,version) values ('Margalo', 58, 167, '94-245-3319', true,1L);
--products sold
